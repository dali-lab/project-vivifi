...
We'll have to use some Terminal command line dark magic here.  Copy/paste is your friend.  
  ...
  <br>![](docs/img/square.png) 2.2)  ```git clone https://github.com/dali-lab/project-vivifi.git```
  <br>![](docs/img/square.png) 2.3)  ```cd project-vivifi```
...
Now you can go to [http://dali-lab.github.io/project-vivifi](http://dali-lab.github.io/project-vivifi) to see your site!
